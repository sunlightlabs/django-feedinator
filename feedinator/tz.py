"""
Original source taken from http://docs.python.org/lib/tzinfo-examples.txt.
Updates and changes have been added.
"""
...
def second_sunday_on_or_after(dt):
    return first_sunday_on_or_after(dt) + timedelta(7)
